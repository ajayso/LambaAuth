...
aws iam delete-role-policy --role-name LambaAuthStorageSettings --policy-name LambaAuthStorageSettings
...
aws lambda delete-function --function-name LambaAuthStorageSettings --region $REGION
